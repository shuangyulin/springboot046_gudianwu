<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拍摄地点" prop="paishedidian">
          <el-input v-model="ruleForm.paishedidian" 
              placeholder="拍摄地点" clearable  :readonly="ro.paishedidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="拍摄地点" prop="paishedidian">
              <el-input v-model="ruleForm.paishedidian" 
                placeholder="拍摄地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wudaojiaoliu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wudaojiaoliuCrossAddOrUpdateFlag = false;
                  this.parent.search();
